		...
		public void OnGUI()
		{
			...
			GUILayout.BeginHorizontal();
				...
				EditorGUILayout.LabelField(
					"Currently installed: Version 2.04 for Unity 6000.2.0f1 and URP 17.2.0 (August 03, 2025)", _style_bodytxt);
				GUILayout.Space(16);
			GUILayout.EndHorizontal();
			...
			GUILayout.BeginHorizontal();
				GUILayout.Space(16);
				EditorGUILayout.LabelField(
					"The package you have downloaded from the asset store installed shaders compatible with URP 17.2.0. " + 
