...
namespace Obi
{
    ...
    public class InstancedRenderBatch : IRenderBatch
    {
        ...
        public int CompareTo(IRenderBatch other)
        {
            ...
            int idA = material != null ? material.GetHashCode() : 0;
            int idB = (ibatch != null && ibatch.material != null) ? ibatch.material.GetHashCode() : 0;

            int compareMat = idA.CompareTo(idB);
            if (compareMat == 0)
            {
                idA = mesh != null ? mesh.GetHashCode() : 0;
                idB = (ibatch != null && ibatch.mesh != null) ? ibatch.mesh.GetHashCode() : 0;
