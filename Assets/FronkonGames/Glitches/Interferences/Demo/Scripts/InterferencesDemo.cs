...
namespace FronkonGames.Glitches.Interferences
{
  ...
  public class InterferencesDemo : MonoBehaviour
  {
    ...
    private InterferencesVolume volume;
    ...
    private void Awake()
    {
      ...
      volume = volumeProfile != null && volumeProfile.TryGet(out InterferencesVolume vol) ? vol : null;
      this.enabled = Interferences.IsInRenderFeatures() && volume != null;
    }
    ...
    private void OnGUI()
    {
      ...
      GUILayout.BeginHorizontal();
      {
        GUILayout.BeginVertical("box", GUILayout.Width(450.0f), GUILayout.Height(Screen.height));
        {
          ...
          volume.offset.value = SliderField("Offset", volume.offset.value, 0.0f, 10.0f);
          volume.distortion.value = SliderField("Distortion", volume.distortion.value, 0.0f, 2.0f);
