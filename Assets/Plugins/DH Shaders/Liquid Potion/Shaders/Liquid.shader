Shader "DH/Liquid Potion/Liquid"
{
    Properties
    {
        ...
        _Multiplier ("Multiplier", Range(1,4)) = 1
        _MidAmount ("Mid Amount", Range(0,.2)) = 0
    }
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert (appdata v)
            {
                ...
                o.liquidEdge = worldPosition.y - _LiquidAmount * _Multiplier;
            ...
            {
                fixed4 midEdge = step(i.liquidEdge, 0.5) - smoothstep(i.liquidEdge, 0.5,(0.5-_MidAmount* max(1,_Multiplier/5)));
