	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float2 texCoord68_g55 = input.ase_texcoord4.xy * float2( 2,2 ) + float2( 0,0 );
				...
				float2 texCoord103_g55 = input.ase_texcoord4.xy * float2( 2,2 ) + float2( 0,0 );
				...
				float2 texCoord68_g54 = input.ase_texcoord4.xy * float2( 2,2 ) + float2( 0,0 );
				...
				float2 texCoord103_g54 = input.ase_texcoord4.xy * float2( 2,2 ) + float2( 0,0 );
				...
				float randomUV288 = input.ase_texcoord5.z;
				...
				float temp_output_118_0 = ( ( saturate( input.ase_texcoord4.z ) * temp_output_280_0 ) * _OpacityMultiply );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 temp_output_73_0_g55 = _Lines01UVPanSpeed;
				float2 texCoord68_g55 = input.ase_texcoord3.xy * float2( 2,2 ) + float2( 0,0 );
				float2 temp_output_86_0_g55 = ( texCoord68_g55 - float2( 1,1 ) );
				float2 appendResult93_g55 = (float2(frac( ( atan2( (temp_output_86_0_g55).x , (temp_output_86_0_g55).y ) / TWO_PI ) ) , length( temp_output_86_0_g55 )));
				float2 panner59_g55 = ( ( (temp_output_73_0_g55).x * _TimeParameters.x ) * float2( 1,0 ) + appendResult93_g55);
				float2 texCoord103_g55 = input.ase_texcoord3.xy * float2( 2,2 ) + float2( 0,0 );
				float2 temp_output_104_0_g55 = ( texCoord103_g55 - float2( 1,1 ) );
				float2 appendResult107_g55 = (float2(frac( ( atan2( (temp_output_104_0_g55).x , (temp_output_104_0_g55).y ) / TWO_PI ) ) , length( temp_output_104_0_g55 )));
				float2 panner60_g55 = ( ( _TimeParameters.x * (temp_output_73_0_g55).y ) * float2( 0,1 ) + appendResult93_g55);
				float2 appendResult90_g55 = (float2(( (panner59_g55).x + ( (appendResult107_g55).y * _Lines01UVSwirl ) ) , (panner60_g55).y));
				...
				float2 temp_output_234_0 = ( ( 1.0 - temp_output_220_100 ) + _Vector4 );
				float2 temp_output_73_0_g54 = _DistortionUVPanSpeed;
				float2 texCoord68_g54 = input.ase_texcoord3.xy * float2( 2,2 ) + float2( 0,0 );
				float2 temp_output_86_0_g54 = ( texCoord68_g54 - float2( 1,1 ) );
				float2 appendResult93_g54 = (float2(frac( ( atan2( (temp_output_86_0_g54).x , (temp_output_86_0_g54).y ) / TWO_PI ) ) , length( temp_output_86_0_g54 )));
				float2 panner59_g54 = ( ( (temp_output_73_0_g54).x * _TimeParameters.x ) * float2( 1,0 ) + appendResult93_g54);
				float2 texCoord103_g54 = input.ase_texcoord3.xy * float2( 2,2 ) + float2( 0,0 );
				float2 temp_output_104_0_g54 = ( texCoord103_g54 - float2( 1,1 ) );
				float2 appendResult107_g54 = (float2(frac( ( atan2( (temp_output_104_0_g54).x , (temp_output_104_0_g54).y ) / TWO_PI ) ) , length( temp_output_104_0_g54 )));
				float2 panner60_g54 = ( ( _TimeParameters.x * (temp_output_73_0_g54).y ) * float2( 0,1 ) + appendResult93_g54);
				float2 appendResult90_g54 = (float2(( (panner59_g54).x + ( (appendResult107_g54).y * _DistortionUVSwirl ) ) , (panner60_g54).y));
				float randomUV288 = input.ase_texcoord4.z;
				float4 temp_output_208_0 = ( tex2D( _DistortionTexture, ( ( _DistortionUVScale * appendResult90_g54 ) + randomUV288 ) ) * _DistortionMultiply );
				float2 temp_output_73_0_g56 = _Lines02UVPanSpeed;
				...
				float temp_output_275_0 = (( temp_output_220_100 + -0.45 )).y;
				float temp_output_280_0 = saturate( ( ( ( tex2D( _LinesTexture, ( float4( temp_output_234_0, 0.0 , 0.0 ) + temp_output_208_0 ).rg ).g * tex2D( _LinesTexture, ( ( float4( ( 1.0 - ( _Lines02UVScale * appendResult90_g56 ) ), 0.0 , 0.0 ) + temp_output_208_0 ) + randomUV288 ).rg ).g ) * pow( temp_output_275_0 , _MaskPower ) ) * _LinesMultiply ) );
				float temp_output_118_0 = ( ( saturate( input.ase_texcoord3.z ) * temp_output_280_0 ) * _OpacityMultiply );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_TARGET
			{
				...
				float2 temp_output_73_0_g55 = _Lines01UVPanSpeed;
				float2 texCoord68_g55 = input.ase_texcoord.xy * float2( 2,2 ) + float2( 0,0 );
				float2 temp_output_86_0_g55 = ( texCoord68_g55 - float2( 1,1 ) );
				float2 appendResult93_g55 = (float2(frac( ( atan2( (temp_output_86_0_g55).x , (temp_output_86_0_g55).y ) / TWO_PI ) ) , length( temp_output_86_0_g55 )));
				float2 panner59_g55 = ( ( (temp_output_73_0_g55).x * _TimeParameters.x ) * float2( 1,0 ) + appendResult93_g55);
				float2 texCoord103_g55 = input.ase_texcoord.xy * float2( 2,2 ) + float2( 0,0 );
				float2 temp_output_104_0_g55 = ( texCoord103_g55 - float2( 1,1 ) );
				float2 appendResult107_g55 = (float2(frac( ( atan2( (temp_output_104_0_g55).x , (temp_output_104_0_g55).y ) / TWO_PI ) ) , length( temp_output_104_0_g55 )));
				float2 panner60_g55 = ( ( _TimeParameters.x * (temp_output_73_0_g55).y ) * float2( 0,1 ) + appendResult93_g55);
				float2 appendResult90_g55 = (float2(( (panner59_g55).x + ( (appendResult107_g55).y * _Lines01UVSwirl ) ) , (panner60_g55).y));
				...
				float2 temp_output_234_0 = ( ( 1.0 - temp_output_220_100 ) + _Vector4 );
				float2 temp_output_73_0_g54 = _DistortionUVPanSpeed;
				float2 texCoord68_g54 = input.ase_texcoord.xy * float2( 2,2 ) + float2( 0,0 );
				float2 temp_output_86_0_g54 = ( texCoord68_g54 - float2( 1,1 ) );
				float2 appendResult93_g54 = (float2(frac( ( atan2( (temp_output_86_0_g54).x , (temp_output_86_0_g54).y ) / TWO_PI ) ) , length( temp_output_86_0_g54 )));
				float2 panner59_g54 = ( ( (temp_output_73_0_g54).x * _TimeParameters.x ) * float2( 1,0 ) + appendResult93_g54);
				float2 texCoord103_g54 = input.ase_texcoord.xy * float2( 2,2 ) + float2( 0,0 );
				float2 temp_output_104_0_g54 = ( texCoord103_g54 - float2( 1,1 ) );
				float2 appendResult107_g54 = (float2(frac( ( atan2( (temp_output_104_0_g54).x , (temp_output_104_0_g54).y ) / TWO_PI ) ) , length( temp_output_104_0_g54 )));
				float2 panner60_g54 = ( ( _TimeParameters.x * (temp_output_73_0_g54).y ) * float2( 0,1 ) + appendResult93_g54);
				float2 appendResult90_g54 = (float2(( (panner59_g54).x + ( (appendResult107_g54).y * _DistortionUVSwirl ) ) , (panner60_g54).y));
				float randomUV288 = input.ase_texcoord1.z;
				float4 temp_output_208_0 = ( tex2D( _DistortionTexture, ( ( _DistortionUVScale * appendResult90_g54 ) + randomUV288 ) ) * _DistortionMultiply );
				float2 temp_output_73_0_g56 = _Lines02UVPanSpeed;
				...
				float temp_output_275_0 = (( temp_output_220_100 + -0.45 )).y;
				float temp_output_280_0 = saturate( ( ( ( tex2D( _LinesTexture, ( float4( temp_output_234_0, 0.0 , 0.0 ) + temp_output_208_0 ).rg ).g * tex2D( _LinesTexture, ( ( float4( ( 1.0 - ( _Lines02UVScale * appendResult90_g56 ) ), 0.0 , 0.0 ) + temp_output_208_0 ) + randomUV288 ).rg ).g ) * pow( temp_output_275_0 , _MaskPower ) ) * _LinesMultiply ) );
				float temp_output_118_0 = ( ( saturate( input.ase_texcoord.z ) * temp_output_280_0 ) * _OpacityMultiply );
		...
		Pass
		{
				 ...
				 )
			{
				...
				float2 temp_output_73_0_g55 = _Lines01UVPanSpeed;
				float2 texCoord68_g55 = input.ase_texcoord2.xy * float2( 2,2 ) + float2( 0,0 );
				float2 temp_output_86_0_g55 = ( texCoord68_g55 - float2( 1,1 ) );
				float2 appendResult93_g55 = (float2(frac( ( atan2( (temp_output_86_0_g55).x , (temp_output_86_0_g55).y ) / TWO_PI ) ) , length( temp_output_86_0_g55 )));
				float2 panner59_g55 = ( ( (temp_output_73_0_g55).x * _TimeParameters.x ) * float2( 1,0 ) + appendResult93_g55);
				float2 texCoord103_g55 = input.ase_texcoord2.xy * float2( 2,2 ) + float2( 0,0 );
				float2 temp_output_104_0_g55 = ( texCoord103_g55 - float2( 1,1 ) );
				float2 appendResult107_g55 = (float2(frac( ( atan2( (temp_output_104_0_g55).x , (temp_output_104_0_g55).y ) / TWO_PI ) ) , length( temp_output_104_0_g55 )));
				float2 panner60_g55 = ( ( _TimeParameters.x * (temp_output_73_0_g55).y ) * float2( 0,1 ) + appendResult93_g55);
				float2 appendResult90_g55 = (float2(( (panner59_g55).x + ( (appendResult107_g55).y * _Lines01UVSwirl ) ) , (panner60_g55).y));
				...
				float2 temp_output_234_0 = ( ( 1.0 - temp_output_220_100 ) + _Vector4 );
				float2 temp_output_73_0_g54 = _DistortionUVPanSpeed;
				float2 texCoord68_g54 = input.ase_texcoord2.xy * float2( 2,2 ) + float2( 0,0 );
				float2 temp_output_86_0_g54 = ( texCoord68_g54 - float2( 1,1 ) );
				float2 appendResult93_g54 = (float2(frac( ( atan2( (temp_output_86_0_g54).x , (temp_output_86_0_g54).y ) / TWO_PI ) ) , length( temp_output_86_0_g54 )));
				float2 panner59_g54 = ( ( (temp_output_73_0_g54).x * _TimeParameters.x ) * float2( 1,0 ) + appendResult93_g54);
				float2 texCoord103_g54 = input.ase_texcoord2.xy * float2( 2,2 ) + float2( 0,0 );
				float2 temp_output_104_0_g54 = ( texCoord103_g54 - float2( 1,1 ) );
				float2 appendResult107_g54 = (float2(frac( ( atan2( (temp_output_104_0_g54).x , (temp_output_104_0_g54).y ) / TWO_PI ) ) , length( temp_output_104_0_g54 )));
				float2 panner60_g54 = ( ( _TimeParameters.x * (temp_output_73_0_g54).y ) * float2( 0,1 ) + appendResult93_g54);
				float2 appendResult90_g54 = (float2(( (panner59_g54).x + ( (appendResult107_g54).y * _DistortionUVSwirl ) ) , (panner60_g54).y));
				float randomUV288 = input.ase_texcoord3.z;
				float4 temp_output_208_0 = ( tex2D( _DistortionTexture, ( ( _DistortionUVScale * appendResult90_g54 ) + randomUV288 ) ) * _DistortionMultiply );
				float2 temp_output_73_0_g56 = _Lines02UVPanSpeed;
				...
				float temp_output_275_0 = (( temp_output_220_100 + -0.45 )).y;
				float temp_output_280_0 = saturate( ( ( ( tex2D( _LinesTexture, ( float4( temp_output_234_0, 0.0 , 0.0 ) + temp_output_208_0 ).rg ).g * tex2D( _LinesTexture, ( ( float4( ( 1.0 - ( _Lines02UVScale * appendResult90_g56 ) ), 0.0 , 0.0 ) + temp_output_208_0 ) + randomUV288 ).rg ).g ) * pow( temp_output_275_0 , _MaskPower ) ) * _LinesMultiply ) );
				float temp_output_118_0 = ( ( saturate( input.ase_texcoord2.z ) * temp_output_280_0 ) * _OpacityMultiply );
...
Node;AmplifyShaderEditor.ColorNode;224;-1024,-1152;Inherit;False;Property;_Color;Color;24;0;Create;True;0;0;0;False;0;False;1,1,1,0;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;Vefects/SH_Vefects_URP_VFX_Vignette_Speed_01;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull1;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;3;True;12;all;0;True;True;2;5;True;_Src1;10;True;_Dst1;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;_ZWrite1;True;3;True;_ZTest1;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;25;Surface;1;638255503152939265;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Alpha Clipping;0;638861335538240709;  Use Shadow Threshold;0;0;Cast Shadows;0;638500290705344932;Receive Shadows;1;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;11;False;True;False;True;False;False;True;True;True;False;True;False;;False;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;293;0,100;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=CFDB8783BEBC9EEB77225BD1D66437050F8B4E4C