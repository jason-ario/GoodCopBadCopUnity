	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float randomUV245 = input.ase_texcoord5.z;
				float temp_output_208_0 = ( tex2D( _SmokeTexture, ( ( _SmokeUVScale * appendResult90_g56 ) + randomUV245 ) ).g * _SmokeMultiply );
				float2 texCoord2_g60 = input.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult12_g60 = (float2(_NoiseTileX , _NoiseTileY));
				float2 appendResult13_g60 = (float2(randomUV245 , randomUV245));
				float4 tex2DNode124 = tex2D( _NoiseTexture, ( float3( ( ( texCoord2_g60 * appendResult12_g60 ) + appendResult13_g60 ) ,  0.0 ) + float3(0,0,0) ).xy );
				...
				float2 texCoord27_g59 = input.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_cast_5 = (1.0).xx;
				float2 temp_output_26_0_g59 = ( texCoord27_g59 - temp_cast_5 );
				float temp_output_13_0_g59 = frac( ( atan2( (temp_output_26_0_g59).x , (temp_output_26_0_g59).y ) / 6.283 ) );
				float2 temp_output_17_0_g59 = ( temp_output_26_0_g59 * temp_output_26_0_g59 );
				float temp_output_12_0_g59 = sqrt( ( (temp_output_17_0_g59).x + (temp_output_17_0_g59).y ) );
				float2 appendResult5_g59 = (float2(temp_output_13_0_g59 , temp_output_12_0_g59));
				float2 texCoord11_g57 = input.ase_texcoord4.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_cast_6 = (0.0).xx;
				float2 appendResult3_g57 = (float2((appendResult5_g59).x , ( ( distance( max( ( abs( ( texCoord11_g57 + -0.5 ) ) - ( float2( 0.15,0.15 ) * 0.5 ) ) , float2( 0,0 ) ) , temp_cast_6 ) + _EdgeMaskOffset ) * 1.5 )));
				float temp_output_133_0 = (appendResult3_g57).y;
				float lerpResult224 = lerp( 60.0 , _EdgeMaskPower , ( 1.0 - pow( ( 1.0 - _VignetteON ) , 3.0 ) ));
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = tex2D( _LUT, panner242 ).rgb;
				float Alpha = saturate( ( input.ase_texcoord4.z * saturate( ( ( ( temp_output_208_0 + tex2DNode124.g ) + temp_output_133_0 ) * saturate( ( pow( temp_output_133_0 , lerpResult224 ) * _EdgeMaskMultiply ) ) ) ) ) );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float2 panner60_g56 = ( ( _TimeParameters.x * (temp_output_73_0_g56).y ) * float2( 0,1 ) + appendResult93_g56);
				float2 appendResult90_g56 = (float2(( (panner59_g56).x + ( (appendResult107_g56).y * _SmokeUVSwirl ) ) , (panner60_g56).y));
				float randomUV245 = input.ase_texcoord4.z;
				float temp_output_208_0 = ( tex2D( _SmokeTexture, ( ( _SmokeUVScale * appendResult90_g56 ) + randomUV245 ) ).g * _SmokeMultiply );
				float2 texCoord2_g60 = input.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult12_g60 = (float2(_NoiseTileX , _NoiseTileY));
				float2 appendResult13_g60 = (float2(randomUV245 , randomUV245));
				float4 tex2DNode124 = tex2D( _NoiseTexture, ( float3( ( ( texCoord2_g60 * appendResult12_g60 ) + appendResult13_g60 ) ,  0.0 ) + float3(0,0,0) ).xy );
				float2 texCoord27_g59 = input.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_cast_2 = (1.0).xx;
				float2 temp_output_26_0_g59 = ( texCoord27_g59 - temp_cast_2 );
				float temp_output_13_0_g59 = frac( ( atan2( (temp_output_26_0_g59).x , (temp_output_26_0_g59).y ) / 6.283 ) );
				float2 temp_output_17_0_g59 = ( temp_output_26_0_g59 * temp_output_26_0_g59 );
				float temp_output_12_0_g59 = sqrt( ( (temp_output_17_0_g59).x + (temp_output_17_0_g59).y ) );
				float2 appendResult5_g59 = (float2(temp_output_13_0_g59 , temp_output_12_0_g59));
				float2 texCoord11_g57 = input.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_cast_3 = (0.0).xx;
				float2 appendResult3_g57 = (float2((appendResult5_g59).x , ( ( distance( max( ( abs( ( texCoord11_g57 + -0.5 ) ) - ( float2( 0.15,0.15 ) * 0.5 ) ) , float2( 0,0 ) ) , temp_cast_3 ) + _EdgeMaskOffset ) * 1.5 )));
				float temp_output_133_0 = (appendResult3_g57).y;
				float lerpResult224 = lerp( 60.0 , _EdgeMaskPower , ( 1.0 - pow( ( 1.0 - _VignetteON ) , 3.0 ) ));
				

				float Alpha = saturate( ( input.ase_texcoord3.z * saturate( ( ( ( temp_output_208_0 + tex2DNode124.g ) + temp_output_133_0 ) * saturate( ( pow( temp_output_133_0 , lerpResult224 ) * _EdgeMaskMultiply ) ) ) ) ) );
				float AlphaClipThreshold = 0.5;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_TARGET
			{
				...
				float2 panner60_g56 = ( ( _TimeParameters.x * (temp_output_73_0_g56).y ) * float2( 0,1 ) + appendResult93_g56);
				float2 appendResult90_g56 = (float2(( (panner59_g56).x + ( (appendResult107_g56).y * _SmokeUVSwirl ) ) , (panner60_g56).y));
				float randomUV245 = input.ase_texcoord1.z;
				float temp_output_208_0 = ( tex2D( _SmokeTexture, ( ( _SmokeUVScale * appendResult90_g56 ) + randomUV245 ) ).g * _SmokeMultiply );
				float2 texCoord2_g60 = input.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult12_g60 = (float2(_NoiseTileX , _NoiseTileY));
				float2 appendResult13_g60 = (float2(randomUV245 , randomUV245));
				float4 tex2DNode124 = tex2D( _NoiseTexture, ( float3( ( ( texCoord2_g60 * appendResult12_g60 ) + appendResult13_g60 ) ,  0.0 ) + float3(0,0,0) ).xy );
				float2 texCoord27_g59 = input.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_cast_2 = (1.0).xx;
				float2 temp_output_26_0_g59 = ( texCoord27_g59 - temp_cast_2 );
				float temp_output_13_0_g59 = frac( ( atan2( (temp_output_26_0_g59).x , (temp_output_26_0_g59).y ) / 6.283 ) );
				float2 temp_output_17_0_g59 = ( temp_output_26_0_g59 * temp_output_26_0_g59 );
				float temp_output_12_0_g59 = sqrt( ( (temp_output_17_0_g59).x + (temp_output_17_0_g59).y ) );
				float2 appendResult5_g59 = (float2(temp_output_13_0_g59 , temp_output_12_0_g59));
				float2 texCoord11_g57 = input.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_cast_3 = (0.0).xx;
				float2 appendResult3_g57 = (float2((appendResult5_g59).x , ( ( distance( max( ( abs( ( texCoord11_g57 + -0.5 ) ) - ( float2( 0.15,0.15 ) * 0.5 ) ) , float2( 0,0 ) ) , temp_cast_3 ) + _EdgeMaskOffset ) * 1.5 )));
				float temp_output_133_0 = (appendResult3_g57).y;
				float lerpResult224 = lerp( 60.0 , _EdgeMaskPower , ( 1.0 - pow( ( 1.0 - _VignetteON ) , 3.0 ) ));
				...
				surfaceDescription.Alpha = saturate( ( input.ase_texcoord.z * saturate( ( ( ( temp_output_208_0 + tex2DNode124.g ) + temp_output_133_0 ) * saturate( ( pow( temp_output_133_0 , lerpResult224 ) * _EdgeMaskMultiply ) ) ) ) ) );
		...
		Pass
		{
				 ...
				 )
			{
				...
				float2 panner60_g56 = ( ( _TimeParameters.x * (temp_output_73_0_g56).y ) * float2( 0,1 ) + appendResult93_g56);
				float2 appendResult90_g56 = (float2(( (panner59_g56).x + ( (appendResult107_g56).y * _SmokeUVSwirl ) ) , (panner60_g56).y));
				float randomUV245 = input.ase_texcoord3.z;
				float temp_output_208_0 = ( tex2D( _SmokeTexture, ( ( _SmokeUVScale * appendResult90_g56 ) + randomUV245 ) ).g * _SmokeMultiply );
				float2 texCoord2_g60 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult12_g60 = (float2(_NoiseTileX , _NoiseTileY));
				float2 appendResult13_g60 = (float2(randomUV245 , randomUV245));
				float4 tex2DNode124 = tex2D( _NoiseTexture, ( float3( ( ( texCoord2_g60 * appendResult12_g60 ) + appendResult13_g60 ) ,  0.0 ) + float3(0,0,0) ).xy );
				float2 texCoord27_g59 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_cast_2 = (1.0).xx;
				float2 temp_output_26_0_g59 = ( texCoord27_g59 - temp_cast_2 );
				float temp_output_13_0_g59 = frac( ( atan2( (temp_output_26_0_g59).x , (temp_output_26_0_g59).y ) / 6.283 ) );
				float2 temp_output_17_0_g59 = ( temp_output_26_0_g59 * temp_output_26_0_g59 );
				float temp_output_12_0_g59 = sqrt( ( (temp_output_17_0_g59).x + (temp_output_17_0_g59).y ) );
				float2 appendResult5_g59 = (float2(temp_output_13_0_g59 , temp_output_12_0_g59));
				float2 texCoord11_g57 = input.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 temp_cast_3 = (0.0).xx;
				float2 appendResult3_g57 = (float2((appendResult5_g59).x , ( ( distance( max( ( abs( ( texCoord11_g57 + -0.5 ) ) - ( float2( 0.15,0.15 ) * 0.5 ) ) , float2( 0,0 ) ) , temp_cast_3 ) + _EdgeMaskOffset ) * 1.5 )));
				float temp_output_133_0 = (appendResult3_g57).y;
				float lerpResult224 = lerp( 60.0 , _EdgeMaskPower , ( 1.0 - pow( ( 1.0 - _VignetteON ) , 3.0 ) ));
				...
				float Alpha = saturate( ( input.ase_texcoord2.z * saturate( ( ( ( temp_output_208_0 + tex2DNode124.g ) + temp_output_133_0 ) * saturate( ( pow( temp_output_133_0 , lerpResult224 ) * _EdgeMaskMultiply ) ) ) ) ) );
				float AlphaClipThreshold = 0.5;
...
Node;AmplifyShaderEditor.FunctionNode;126;-2944,1024;Inherit;False;SH_F_Vefects_VFX_SDF_Box_UV;0;;57;7b24bf4a1857f98439a6a786a080fdc7;0;1;7;FLOAT;0;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.FunctionNode;232;-3840,256;Inherit;False;SH_F_Vefects_VFX_UVControls;-1;;60;646903c10e8abfe49bda8ebf1a207339;0;6;1;FLOAT2;0,0;False;4;FLOAT;0;False;7;FLOAT;0;False;9;FLOAT;0;False;11;FLOAT;0;False;16;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SamplerNode;109;-640,-640;Inherit;True;Property;_LUT;LUT;3;0;Create;True;0;0;0;False;3;Space(33);Header(LUT);Space(13);False;-1;00816448001c4f8489fee7c25d462a72;00816448001c4f8489fee7c25d462a72;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;249;0,100;Float;False;False;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;1;New Amplify Shader;2992e84f91cbeb14eab234972e07ea9d;True;MotionVectors;0;10;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Unlit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;False;False;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=MotionVectors;False;False;0;;0;0;Standard;0;False;0
...
ASEEND*/
//CHKSM=5E17DCE4F2330FA675B3C144E1E3C36CE69E71DD