	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float temp_output_117_0 = saturate( ( input.ase_texcoord4.z * saturate( ( ( ( tex2D( _SmokeTexture, ( ( _SmokeUVScale * appendResult90_g56 ) + randomUV245 ) ).g * _SmokeMultiply ) + temp_output_133_0 ) * saturate( ( pow( temp_output_133_0 , lerpResult224 ) * _EdgeMaskMultiply ) ) ) ) ) );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input  ) : SV_TARGET
			{
				...
				float temp_output_133_0 = (appendResult3_g53).y;
				float lerpResult224 = lerp( 60.0 , _EdgeMaskPower , ( 1.0 - pow( ( 1.0 - _VignetteON ) , 3.0 ) ));
				float temp_output_117_0 = saturate( ( input.ase_texcoord3.z * saturate( ( ( ( tex2D( _SmokeTexture, ( ( _SmokeUVScale * appendResult90_g56 ) + randomUV245 ) ).g * _SmokeMultiply ) + temp_output_133_0 ) * saturate( ( pow( temp_output_133_0 , lerpResult224 ) * _EdgeMaskMultiply ) ) ) ) ) );
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_TARGET
			{
				...
				float temp_output_133_0 = (appendResult3_g53).y;
				float lerpResult224 = lerp( 60.0 , _EdgeMaskPower , ( 1.0 - pow( ( 1.0 - _VignetteON ) , 3.0 ) ));
				float temp_output_117_0 = saturate( ( input.ase_texcoord.z * saturate( ( ( ( tex2D( _SmokeTexture, ( ( _SmokeUVScale * appendResult90_g56 ) + randomUV245 ) ).g * _SmokeMultiply ) + temp_output_133_0 ) * saturate( ( pow( temp_output_133_0 , lerpResult224 ) * _EdgeMaskMultiply ) ) ) ) ) );
		...
		Pass
		{
				 ...
				 )
			{
				...
				float temp_output_133_0 = (appendResult3_g53).y;
				float lerpResult224 = lerp( 60.0 , _EdgeMaskPower , ( 1.0 - pow( ( 1.0 - _VignetteON ) , 3.0 ) ));
				float temp_output_117_0 = saturate( ( input.ase_texcoord2.z * saturate( ( ( ( tex2D( _SmokeTexture, ( ( _SmokeUVScale * appendResult90_g56 ) + randomUV245 ) ).g * _SmokeMultiply ) + temp_output_133_0 ) * saturate( ( pow( temp_output_133_0 , lerpResult224 ) * _EdgeMaskMultiply ) ) ) ) ) );
...
Node;AmplifyShaderEditor.SamplerNode;109;-640,-640;Inherit;True;Property;_LUT;LUT;3;0;Create;True;0;0;0;False;3;Space(33);Header(LUT);Space(13);False;-1;d84574ab12d205a439e5f9616ce44b36;d84574ab12d205a439e5f9616ce44b36;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;13;Vefects/SH_Vefects_URP_VFX_Vignette_Charmed_01;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;True;True;0;True;_Cull1;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;False;False;False;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Unlit;True;3;True;12;all;0;True;True;2;5;True;_Src1;10;True;_Dst1;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;_ZWrite1;True;3;True;_ZTest1;True;True;0;False;;0;False;;True;1;LightMode=UniversalForwardOnly;False;False;0;;0;0;Standard;25;Surface;1;638255503152939265;  Blend;0;0;Two Sided;1;0;Forward Only;0;0;Alpha Clipping;0;638861335001260847;  Use Shadow Threshold;0;0;Cast Shadows;0;638500290705344932;Receive Shadows;1;0;Motion Vectors;1;0;  Add Precomputed Velocity;0;0;GPU Instancing;1;0;LOD CrossFade;0;0;Built-in Fog;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;0;11;False;True;False;True;False;False;True;True;True;False;True;False;;False;0
...
ASEEND*/
//CHKSM=1CCD9E7FFAA6290FE69A8F1ACB2493451E235571